    ...
    <div class="col-3"></div>
      ...
      <div class="col-6 border border-secondary rounded">
        <form class="form-signin" method="post" action="php/register.php">
          <h1 class="h3 mb-3 font-weight-normal mt-3">Kayıt Olun</h1>
          ...
          <div class="checkbox mb-3">
            <label>
              <input type="checkbox" value="get-" id="inputSart" name="inputSart" required="">
              <a href="yasalGereklilik.php">Şartları</a> okudum, kabul ediyorum.
            </label>
          </div>
