...
<head>
    ...
    <script src="js/searchPageShow.js"></script>
</head>
<body onload="ajaxSet()">
...
<div class="container my-5 border border-info">
  <h1 class="display-5 text-center mb-2 mt-2">Arama Sonuçlarınız</h1>
  <div class="clearfix"></div>
  <hr class="my-3">
  <div class="row row-cols-1 row-cols-md-4 mb-2" id="urunBolumu1">
