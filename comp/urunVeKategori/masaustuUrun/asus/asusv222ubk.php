  ...
  <div class="row mt-3 mb-3">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="../../../images/masaustuUrun/asus/asus2-1.jpg" class="d-block w-100" alt="arduinouno0">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/asus/asus2-2.jpg" class="d-block w-100" alt="arduinouno0-1">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/asus/asus2-3.jpg" class="d-block w-100" alt="arduinouno0-2">
              </div>
            </div>
    ...
    <div class="col-12 col-md-6">
      <form method="POST" action="../../../php/sepeteEkle.php">
        ...
        <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Asus V222UBK" readonly></h1>
        <p>Intel I3-8130u 8gb 1tb+256ssd 2gb Mx110 21.5 Freedos ASUS V222UBK-BA006D5</p>
        <hr>
        ...
        <ul class="unstyled">
          ...
          <li class="text-muted">
            Ekran Kartı: Nvidia GeForce MX110
          </li>
        </ul>

        <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="5682" readonly> ₺</h2>
