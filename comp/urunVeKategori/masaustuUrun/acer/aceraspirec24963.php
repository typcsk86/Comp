  ...
  <div class="row mt-3 mb-3">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="../../../images/masaustuUrun/acer/acer3-1.jpg" class="d-block w-100" alt="arduinouno0">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/acer/acer3-2.jpg" class="d-block w-100" alt="arduinouno0-1">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/acer/acer3-3.jpg" class="d-block w-100" alt="arduinouno0-2">
              </div>
            </div>
    ...
    <div class="col-12 col-md-6">
      <form method="POST" action="../../../php/sepeteEkle.php">
        ...
        <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Acer Aspire C24-963" readonly></h1>
        <p>Intel Core I5 1035g1 8gb 256gb Sdd 23.8" Fhd Ips W10 Home Dq.berem.001 DQ.BEREM.001</p>
        <hr>
        ...
        <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="6260" readonly> ₺</h2>
