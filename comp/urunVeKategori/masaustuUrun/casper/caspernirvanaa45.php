  ...
  <div class="row mt-3 mb-3">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="../../../images/masaustuUrun/casper/casper1-1.jpg" class="d-block w-100" alt="arduinouno0">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/casper/casper1-2.jpg" class="d-block w-100" alt="arduinouno0-1">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/masaustuUrun/casper/casper1-3.jpg" class="d-block w-100" alt="arduinouno0-2">
              </div>
            </div>
    ...
    <div class="col-12 col-md-6">
      <form method="POST" action="../../../php/sepeteEkle.php">
        ...
        <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Casper Nirvana a45" readonly></h1>
        <p>Intel Core i3 16GB RAM 120GB SSD Windows 10 Pro Full HD</p>
        <hr>
        ...
        <ul class="unstyled">
          ...
          <li class="text-muted">
            SSD Kapasitesi: 120 GB
          </li>
          <li class="text-muted">
            Ekran Boyutu: 22" / 55 Ekran
          </li>
          <li class="text-muted">
            RAM: 16 GB
          </li>
        ...
        <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="8500" readonly> ₺</h2>
