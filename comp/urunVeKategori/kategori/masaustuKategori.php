...
<head>
    ...
    <script src="../../js/urunlerMasaustuApp.js"></script>
...
<div class="container mt-3">
  ...
  <h1 class="display-4 text-center">Masaüstü Bilgisayarlar</h1>
  <hr class="mt-3 mb-3">
  ...
  <div class="row mt-3 p-2">
    ...
    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-3 border-right">
      <form>
        ...
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="masaustu" id="defaultCheck4" name="amac">
          <label class="form-check-label" for="defaultCheck4">
            Masaüstü Bilgisayar
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" value="gaming" id="defaultCheck5" name="amac">
