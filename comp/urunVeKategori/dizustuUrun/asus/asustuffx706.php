  ...
  <div class="row mt-3">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="../../../images/dizustuUrun/asus/asus1-1.jpg" class="d-block w-100" alt="arduinouno0">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/dizustuUrun/asus/asus1-2.jpg" class="d-block w-100" alt="arduinouno0-1">
              </div>
              <div class="carousel-item">
                  <img src="../../../images/dizustuUrun/asus/asus1-3.jpg" class="d-block w-100" alt="arduinouno0-2">
              </div>
            </div>
    ...
    <div class="col-12 col-md-6">
      <form method="POST" action="../../../php/sepeteEkle.php">
        ...
        <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Asus Tuf Gaming Fx706" readonly></h1>
        <p>Intel I5-10300h 8gb Ram 512gb Ssd 4gb Gtx1650ti 17.3 Fhd 144hz FX706LI-HX175</p>
        <hr>
        ...
        <ul class="unstyled">
          ...
          <li class="text-muted">
            Ekran Kartı: Nvidia GeForce GTX1050 Ti
          </li>
        </ul>

        <h2 class="float-right text-primary"><input type="text" class="text-primary mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="8999" readonly> ₺</h2>
